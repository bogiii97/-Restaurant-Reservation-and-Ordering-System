...
@Component({
  selector: 'app-login-password-forget',
  templateUrl: './login-password-forget.component.html',
  styleUrls: ['./login-password-forget.component.css']
})
export class LoginPasswordForgetComponent {
  ...
  getMail(){
    ...
    this.service.getMail(this.email).subscribe(data =>{
      if(data != null){
        this.message = "";
        this.user = data;
